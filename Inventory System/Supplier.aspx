                    ...
                    <table class="nav" style="margin-top: 50px; margin-left: 50px">
                        ...
                        <tr>
                            <td style="width: 490px">
                                ...
                                <asp:RequiredFieldValidator ID="CategoryValidation" runat="server" ControlToValidate="ddlItemType" ErrorMessage="Enter Item Category" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
