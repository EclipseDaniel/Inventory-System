...
<asp:Content ID="AboutBodyContent" ContentPlaceHolderID="BodyContent" runat="server">
                    ...
                    <div class="footer">
                        <div class="container">
                            ...
                            <div class="col-md-3 footer-two">
                                <h5>Information </h5>
                                <ul>
                                    <li><a href="maintenance.html">Tips</a></li>
                                    <li><a href="contact.html">Locations</a></li>
                                    <li><a href="about.html">Deliveries</a></li>
                            ...
                            <div class="col-md-2 footer-four">
                                <h5>Helpful Links </h5>
                                <ul>
                                    <li><a href="maintenance.html">Menu</a></li>
                                    <li><a href="contact.html">Order</a></li>
                                    <li><a href="about.html">Dish</a></li>
                                    <li><a href="about.html">Dessert</a></li>
                                    <li><a href="about.html">Drinks</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-center ">
                                    <div class="copyright-text">
                                        <p>Copyright © 2019 The Cafe By The Ruins. All rights reserved.</p>
                                    </div>
                                </div>
                                <!-- End Col -->
